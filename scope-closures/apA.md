...
- **_IIF_** functions don't move around, why would they need closure?
...
By the way, Chapter 7 briefly mentioned partial application and currying (which _do_ rely on closure!). This is an interesting scenario where manual currying can be used:
